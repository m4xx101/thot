...
rm -f "$H/skins/cryptex.yaml" "$H/hermes-agent/hermes_cli/extended_banner.py" "$H/hermes-agent/gateway/builtin_hooks/boot-cryptex/hook.py" "$H/.cryptex_welcome_sent" "$H/.cryptex_patch_version"
echo -e "${G}✓ Reverted to default Hermes Agent theme.${N}"
